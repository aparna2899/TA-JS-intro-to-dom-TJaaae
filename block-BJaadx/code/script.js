...
let name = document.body.children[6].children[2].name
...
console.log(`The total number of img element is ${imgCount.length}`);
...
let countButtons = document.querySelectorAll('input[type="submit"]')
console.log(countButtons.length);

// 18. Select all the `label` element and log the count.

let countLabels = document.querySelectorAll('label')
console.log(countLabels.length);

// 19. Select all the elements with `id` of `test`

let countIdTest = document.querySelectorAll('#test')
console.log(countIdTest.length);
